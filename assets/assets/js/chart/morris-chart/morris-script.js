...
var morris_chart = {
    init: function() {
        Morris.Area({
            ...
            ykeys: ['y', 'z'],
            labels: ['Y', 'Z'],
            lineColors: [CionAdminConfig.secondary , CionAdminConfig.primary ],
        }), Morris.Line({
            ...
            xkey: "y",
            ykeys: ["a", "b"],
            lineColors: [CionAdminConfig.primary , CionAdminConfig.secondary ],
            ...
            xkey: "x",
            ykeys: ["y", "z", "a"],
            barColors: [CionAdminConfig.primary , CionAdminConfig.secondary ,"#51bb25"],
            labels: ["Y", "Z", "A"]
        }), Morris.Bar({
            ...
            ykeys: ["y"],
            labels: ["Y"],
            barColors: [CionAdminConfig.primary]
        }), $(function() {
            var b = [{
                period: "2012-10-01",
                licensed: 5000,
            ...
            Morris.Bar({
                ...
                data: b,
                barColors: [CionAdminConfig.primary , CionAdminConfig.secondary ],
                xkey: "period",
            ...
            window.m = Morris.Line({
                ...
                labels: ["sin(x)"],
                parseTime: !1,
                lineColors: [CionAdminConfig.primary],
            ...
            Morris.Donut({
                ...
                labelColor: "#999999",
                colors: [CionAdminConfig.primary , CionAdminConfig.secondary ,"#f8d62b" ,"#51bb25" ,"rgba(248, 214, 43, 1)", "#51bb25" ,"#f8d62b"],
            ...
            Morris.Bar({
                ...
                ykeys: ["y", "z", "a"],
                labels: ["A", "Y", "Z"],
                barColors: [CionAdminConfig.primary , CionAdminConfig.secondary ,"#51bb25" ,"#f8d62b" ,"#a927f9", CionAdminConfig.secondary , CionAdminConfig.primary ],
                stacked: !0
            });
        });
    }
