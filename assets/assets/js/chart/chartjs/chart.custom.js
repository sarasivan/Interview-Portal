...
var barData = {
    ...
    datasets: [{
        ...
        highlightStroke: CionAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: CionAdminConfig.secondary ,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: CionAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight: CionAdminConfig.primary,
        label: "Yellow"
    }, {
        value: 50,
        color: "#f8d62b",
        ...
        highlight: CionAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: CionAdminConfig.primary ,
        pointColor: CionAdminConfig.primary ,
        ...
        strokeColor: CionAdminConfig.secondary ,
        pointColor: CionAdminConfig.secondary ,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: CionAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: CionAdminConfig.primary,
        pointColor: CionAdminConfig.primary,
        pointStrokeColor: CionAdminConfig.primary,
        pointHighlightFill: CionAdminConfig.primary ,
